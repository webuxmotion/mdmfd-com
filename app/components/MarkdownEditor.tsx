...
export default function MarkdownEditor({ value, onChange, masked = false, onToggleVisibility, isEncrypted = false }: MarkdownEditorProps) {
        ...
        <div className="border border-[var(--border-color)] rounded-lg overflow-hidden bg-[var(--surface)]">
          ...
          <div className="flex items-center justify-between p-3 border-b border-[var(--border-color)] bg-[var(--surface-hover)]">
            <div className="flex items-center gap-2">
              <svg viewBox="0 0 24 24" className="w-5 h-5 text-[var(--text-muted)] fill-current">
                <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
              </svg>
              <span className="text-[var(--text-muted)] text-sm font-medium">
                {isEncrypted ? 'Encrypted README (hidden)' : 'README (hidden)'}
              </span>
            </div>
            {onToggleVisibility && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-[var(--primary)] text-white rounded-md text-sm font-medium hover:bg-[var(--primary-dark)] transition-colors"
              >
          ...
          <div className="p-4 min-h-[200px] flex items-center justify-center">
            <div className="text-center">
              <div className="text-4xl text-[var(--text-muted)] tracking-widest mb-3">
                ••••••••••••
              </div>
          ...
          <div className="flex items-center gap-1 p-2 border-b border-[var(--border-color)] bg-[var(--surface-hover)] flex-wrap">
            ...
            {onToggleVisibility && (
              <button
                ...
                onClick={onToggleVisibility}
                title="Hide content"
                className="p-2 hover:bg-[var(--surface)] rounded transition-colors text-[var(--text-muted)] flex items-center gap-1"
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
